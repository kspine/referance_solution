...
std::uint64_t StrategicResource::harvest(const boost::shared_ptr<MapObject> &harvester, double amount_to_harvest, bool saturated){
    ...
    LOG_EMPERY_CENTER_DEBUG("ResourceCrate::amount_to_harvest = ", amount_to_harvest, 
				", rounded_amount_to_harvest:",rounded_amount_to_harvest,
				", rounded_amount_removable:",rounded_amount_removable,
				", amount_removed:",amount_removed,
				" ,harvest_remainder " ,m_harvest_remainder);
