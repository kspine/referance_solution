...
namespace EmperyCenter{
  ...
  struct CastleOfflineUpgradeBuildingBaseMap{
        ...
        static boost::shared_ptr<MongoDb::Center_CastleOfflineUpgradeBuildingBase> find(AccountUuid account_uuid,MapObjectUuid map_object_uuid);

        static void insert(const boost::shared_ptr<MongoDb::Center_CastleOfflineUpgradeBuildingBase> &obj);
