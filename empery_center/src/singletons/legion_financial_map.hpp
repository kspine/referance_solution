...
namespace EmperyCenter
{
   ...
   static void insert(const boost::shared_ptr<MongoDb::Center_LegionFinancial> &legionfinancials);
   ...
   static void  get_legion_financial(LegionUuid legion_uuid,std::vector<boost::shared_ptr<MongoDb::Center_LegionFinancial>> &ret);
