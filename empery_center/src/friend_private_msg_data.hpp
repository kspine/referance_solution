...
private:
	const boost::shared_ptr<MongoDb::Center_FriendPrivateMsgData> m_obj;
...
public:
	...
	explicit FriendPrivateMsgData(boost::shared_ptr<MongoDb::Center_FriendPrivateMsgData> obj);
