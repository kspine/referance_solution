...
#define MONGODB_OBJECT_PRIMARY_KEY {return PRIMERY_KEYGEN::GenIDS::GenId(account_uuid,map_activity_id,avaliable_since);}
...
#define MONGODB_OBJECT_PRIMARY_KEY {return PRIMERY_KEYGEN::GenIDS::GenId(account_uuid,map_activity_id,settle_date);}
#define MONGODB_OBJECT_FIELDS \
	FIELD_UUID              (account_uuid)	 \
	FIELD_UNSIGNED          (map_activity_id)\
...
#define MONGODB_OBJECT_PRIMARY_KEY {return PRIMERY_KEYGEN::GenIDS::GenId(activity_id,cluster_x,cluster_y,since);}
#define MONGODB_OBJECT_FIELDS \
...
#define MONGODB_OBJECT_PRIMARY_KEY {return PRIMERY_KEYGEN::GenIDS::GenId(account_uuid,activity_id,cluster_x,cluster_y,since);}
#define MONGODB_OBJECT_FIELDS \
	FIELD_UUID              (account_uuid)	 \
	FIELD_UNSIGNED          (activity_id)\
	FIELD_SIGNED            (cluster_x)	\
...
#define MONGODB_OBJECT_PRIMARY_KEY {return PRIMERY_KEYGEN::GenIDS::GenId(account_uuid,cluster_x,cluster_y,since);}
#define MONGODB_OBJECT_FIELDS \
	FIELD_UUID              (account_uuid)	 \
	FIELD_SIGNED            (cluster_x)	\
	FIELD_SIGNED            (cluster_y)	\
...
#define MONGODB_OBJECT_PRIMARY_KEY {return PRIMERY_KEYGEN::GenIDS::GenId(cluster_x,cluster_y,since);}
#define MONGODB_OBJECT_FIELDS \
	FIELD_SIGNED            (cluster_x) \
	FIELD_SIGNED            (cluster_y) \
	FIELD_DATETIME          (since) \
