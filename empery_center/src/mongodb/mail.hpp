...
#define MONGODB_OBJECT_PRIMARY_KEY {return PRIMERY_KEYGEN::GenIDS::GenId(mail_uuid,account_uuid);} 
...
#define MONGODB_OBJECT_PRIMARY_KEY {return PRIMERY_KEYGEN::GenIDS::GenId(mail_uuid,language_id);}
#define MONGODB_OBJECT_FIELDS \
	FIELD_UUID              (mail_uuid)	\
