#ifndef EMPERY_CENTER_LOG_MONGODB_AUCTION_ITEM_CHANGED_HPP_
#define EMPERY_CENTER_LOG_MONGODB_AUCTION_ITEM_CHANGED_HPP_
...
#define MONGODB_OBJECT_NAME   CenterLog_AuctionItemChanged
